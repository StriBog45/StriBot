        ...
        public Dictionary<string, Command> CreateCommands()
            => new Dictionary<string, Command>
            {
                ...
                new Command("Daisy", "Показывает ссылку на twitch Daisy(roliepolietrolie)",
                    delegate(CommandInfo e)
                    {
                        GlobalEventContainer.Message(
                            "Любимая австралийка, обладает хорошим чувством юмора. Не понимает русский, но старается его переводить. А также обожает Dota 2 <3 , twitch.tv/squintee",
                            e.Platform);
                ...
                new Command("Katenok", "Показывает ссылку на twitch Katenok",
                    ...
                    {
                        GlobalEventContainer.Message(
                            "Очаровашка Катенок(Ffunnya), улыбчивая и светлая персона! Любит DBD и Dota 2 <3 , twitch.tv/squintee",
                            e.Platform);
                    }, CommandType.Streamers),
                ...
                new Command("Gohapsp", "Показывает ссылку на twitch Gohapsp",
                    delegate(CommandInfo e)
                    {
                        GlobalEventContainer.Message("Специалист по хоррорам, twitch.tv/gohapsp", e.Platform);
                    }, CommandType.Streamers),

                new Command("Stone", "Показывает ссылку на twitch Камушка",
                    delegate(CommandInfo e)
                    {
                        GlobalEventContainer.Message("Самый очаровательный камушек! <3 , twitch.tv/sayyees",
                            e.Platform);
                    }, CommandType.Streamers),
                ...
                new Command("Бескрыл", "Показывает ссылку на twitch Бескрыл-а",
                    ...
                    {
                        GlobalEventContainer.Message(
                            "Свежие одиночные игры на прохождение :) Добрый, отзывчивый, не оставит без внимания никого! К слову, он разработчик и у него уже есть своя игра! :) twitch.tv/beskr1l_",
                            e.Platform);
                    }, CommandType.Streamers),
                ...
                new Command("Welovegames", "Показывает ссылку на twitch Welovegames",
                    ...
                    {
                        GlobalEventContainer.Message(
                            "Хранитель убежища, харизматичный Денис! Если вы о нём ещё не знаете, крайне рекомендую посмотреть на его деятельность. p.s. обожаю его смайлы. twitch.tv/welovegames",
                            e.Platform);
                    }, CommandType.Streamers),
                ...
                new Command("StrykOFF", "Показывает ссылку на twitch StrykOFF",
                    ...
                    {
                        GlobalEventContainer.Message(
                            "Владелец таверны, создатель лучших шаверм! Для ламповых посиделок :) twitch.tv/strykoff",
                            e.Platform);
                    }, CommandType.Streamers),
                ...
                new Command("Tilttena", "Показывает ссылку на twitch Tilttena",
                    delegate(CommandInfo e)
                    {
                        GlobalEventContainer.Message("Горящая Алёна!, twitch.tv/tilttena", e.Platform);
                    }, CommandType.Streamers),

                new Command("Bezumnaya", "Показывает ссылку на twitch Bezumnaya",
                    delegate(CommandInfo e)
                    {
                        GlobalEventContainer.Message("Безумно любит своих зрителей, twitch.tv/bezumnaya",
                            e.Platform);
                    }, CommandType.Streamers),
                ...
                new Command("Starval", "Показывает ссылку на twitch Starval",
                    delegate(CommandInfo e)
                    {
                        GlobalEventContainer.Message("Лера. Киев. Стример. :), twitch.tv/starval", e.Platform);
                    }, CommandType.Streamers),

                new Command("Aiana", "Показывает ссылку на twitch AianaKim",
                    delegate(CommandInfo e)
                    {
                        GlobalEventContainer.Message("Наша улыбашка-очаровашка Аяна BLELELE  twitch.tv/aianakim",
                            e.Platform);
                    }, CommandType.Streamers),
                ...
                new Command("Reara", "Показывает ссылку на twitch SyndicateReara",
                    ...
                    {
                        GlobalEventContainer.Message(
                            "Незабудь выполнить воинское приветствие striboF twitch.tv/syndicatereara", e.Platform);
                    }, CommandType.Streamers)
